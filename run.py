...
def validate_data(values):
    ...
    Raises ValueError if strings cannot be converted into itn,
...
#def update_surplus_worksheet(data):
    #"""
    #Update surplus worksheet, add new with the list data provided
    #"""
...
def get_last_5_entries_sales():
    """
    Collects collumns of data from sale worksheet, collecting the last 
...
def calculate_stock_data(data):
    """
    Calculate the average stock for eating
    """
